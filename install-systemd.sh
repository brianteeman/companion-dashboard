#!/bin/bash
# Companion Dashboard Universal Installer (systemd version)
# Automatically downloads and installs the latest Companion Dashboard release for your architecture
# Uses systemd service for auto-start (recommended for Raspberry Pi 5)

set -e

REPO="tomhillmeyer/companion-dashboard"
INSTALL_SCRIPT="install-linux-server-systemd.sh"

echo "=== Companion Dashboard Universal Installer (systemd) ==="
echo ""
...
echo "  • Configure auto-login and systemd service for auto-start"
